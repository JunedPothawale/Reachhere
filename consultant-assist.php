      ...
      <div class="row g-5">
        <div class="col-lg-3 d-none d-lg-block">
          <div class="testimonial-left h-100">
            <img class="img-fluid animated pulse infinite" src="img\images.png" alt="" />
            <img class="img-fluid animated pulse infinite" src="img\images.jfif" alt="" />
            <img class="img-fluid animated pulse infinite" src="img\images (1).jfif" alt="" />
          </div>
        </div>
