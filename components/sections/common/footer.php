<div class="container-fluid bg-dark footer  py-1 pt-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-1">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <p>
                    <i class="fa fa-map-marker-alt me-3"></i>Yashodeep Heights, Amrut Dham, Gothivali Village, Sector
                    30, Rabale, Navi Mumbai, Maharashtra 400701
                </p>
                <p><i class="fa fa-phone-alt me-3"></i>m: +91 7777 80 3030</p>
                <p><i class="fa fa-envelope me-3"></i>e: info@reachhere.in</p>
            </div>
            <div class="col-lg-4 col-md-6">
          <h5 class="text-light display-6 mb-4">Quick Links</h5>
          <a class="btn btn-link" href="about.php">About Us</a>
          <a class="btn btn-link" href="contact.php">Contact Us</a>
          <a class="btn btn-link" href="activites.php">Our Services</a>
    ...
    <div class="copy-right mt-1 mb-4">
        <a class="btn btn-link text-center" href="http://www.whizzactsolutions.com/"> &#169;&nbsp;Design By WhizzAct
            Solutions</a>
    </div>
